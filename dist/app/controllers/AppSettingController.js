...
const AppSetting_1 = __importDefault(require("@/app/models/AppSetting"));
...
class AppSettingController extends AbstractController_1.default {
    generateMethods() {
        return [
            {
                name: 'list',
    ...
    add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield Company_1.default.findById(company))) {
            ...
            if (!(yield Location_1.default.findById(location))) {
                throw new AdvancedError_1.default({
                    location: {
                        kind: 'not.found',
            ...
            res.send(new ResponseResult_1.default({
                ...
                data: yield AppSetting_1.default.create(Object.assign(Object.assign({}, body), defaultData_1.APP_SETTING)),
            }));
        });
    }
    getByLocation(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const item = yield AppSetting_1.default.findOne({ location }).exec();
            if (!item) {
                throw new AdvancedError_1.default({
                    appSetting: {
                        kind: 'not.found',
    ...
    updateApi(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const appSetting = yield AppSetting_1.default.findById(id);
            if (!appSetting) {
                throw new AdvancedError_1.default({
                    location: {
                        kind: 'not.found',
    ...
    updateDefaultSettings(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { body: { id }, } = req;
            const appSetting = yield this.model.findById(id).exec();
            if (!appSetting) {
                throw new AdvancedError_1.default({
                    appSetting: {
                        kind: 'not.found',
            ...
            yield AppSetting_1.default.findByIdAndUpdate(id, defaultData_1.APP_SETTING).exec();
            res.send(new ResponseResult_1.default({
...
exports.default = new AppSettingController(AppSetting_1.default);
//# sourceMappingURL=AppSettingController.js.map