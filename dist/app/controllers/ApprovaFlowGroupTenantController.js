...
const ApprovalFlowGroupTenant_1 = __importDefault(require("../models/ApprovalFlowGroupTenant"));
...
class ApprovalFlowGroupController extends AbstractController_1.default {
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.send(new ResponseResult_1.default({
                data: yield ApprovalFlowGroupTenant_1.default.getInstance(tenantId)
                    .find(filter)
                    .exec(),
    ...
    add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.send(new ResponseResult_1.default({
                ...
                data: yield ApprovalFlowGroupTenant_1.default.getInstance(tenantId).create(body),
            }));
        });
    }
    /**
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const item = yield ApprovalFlowGroupTenant_1.default.getInstance(tenantId)
                .findOne({
                _id: id,
                company: currentUser.employee.company,
            })
            ...
            if (!item) {
                throw new AdvancedError_1.default({
                    approvalFlowGroup: {
                        kind: 'not.found',
                        message: 'Approval Flow Group not found',
                    },
                });
            }
    ...
    remove(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const approvalFlow = yield ApprovalFlowTenant_1.default.getInstance(tenantId)
                .find({
                'nodes.value': id,
                status: 'ACTIVE',
            })
...
//# sourceMappingURL=ApprovaFlowGroupTenantController.js.map