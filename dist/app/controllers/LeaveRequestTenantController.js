...
// import LeaveRequestTenant from '../models/LeaveRequestTenant'
...
const LeaveRequestTenant_1 = __importDefault(require("../models/LeaveRequestTenant"));
...
class LeaveRequestTenantController extends AbstractController_1.default {
    generateMethods() {
        return [
            {
                name: 'add',
    ...
    add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { tenantId, leaveDates, type, cc } = req.body;
            ...
            const currentTimeoffType = yield TimeoffTypeTenant_1.default.getInstance(tenantId)
                .findOne({
                _id: type,
            })
            ...
            const newLeaveRequest = yield LeaveRequestTenant_1.default.getInstance(tenantId).create(newLeaveRequestData);
            ...
            const ccEmployees = yield bluebird_1.default.map(cc, (ccPerson) => __awaiter(this, void 0, void 0, function* () {
                const foundCcPerson = yield EmployeeTenant_1.default.getInstance(tenantId).findById(mongoose_1.Types.ObjectId(ccPerson));
            ...
            const requesteeName = `${employeeGeneralInfo.firstName} ${employeeGeneralInfo.lastName}`;
      ...
      <ul>${leaveContent}</ul>
            ...
            let managerName = '';
            if (employee.manager) {
                managerName = `${managerGeneralInfo.firstName} ${managerGeneralInfo.lastName}`;
            }
            ...
            yield SendMail_1.sendLeaveRequestMail({
                email: employee.manager ? managerGeneralInfo.workEmail : '',
                fullName: managerName,
            }, [], mailTitle, mailContent);
            // Send mails to time off CC
            yield bluebird_1.default.map(ccEmployees, (ccEmployee) => __awaiter(this, void 0, void 0, function* () {
                const ccEmployeeGeneralInfo = yield GeneralInfoTenant_1.default.getInstance(tenantId).findOne({
                    employee: ccEmployee,
                });
                const ccEmployeeEmail = ccEmployeeGeneralInfo.workEmail;
                const ccEmployeeName = `${ccEmployeeGeneralInfo.firstName} ${ccEmployeeGeneralInfo.lastName}`;
                yield SendMail_1.sendLeaveRequestMail({
                    email: ccEmployeeEmail,
                    fullName: ccEmployeeName,
                }, [], mailTitle, mailContent);
            }));
            const hrManagers = yield this.getHrManagerByLocation(employee.location._id, req);
            // Send mail to HR Managers
            yield bluebird_1.default.map(hrManagers, (hrManager) => __awaiter(this, void 0, void 0, function* () {
                const email = hrManager.generalInfo.workEmail;
                const fullName = `${hrManager.generalInfo.firstName} ${hrManager.generalInfo.lastName}`;
                yield SendMail_1.sendLeaveRequestMail({
                    email,
                    fullName,
                }, [], mailTitle, mailContent);
    ...
    remove(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const leaveRequest = yield LeaveRequestTenant_1.default.getInstance(tenantId).findById(id);
            if (!leaveRequest) {
                throw new AdvancedError_1.default({
                    leaveRequest: { kind: 'not.found', message: 'Leave Request not found' },
                });
            }
            yield leaveRequest.remove();
            res.send(new ResponseResult_1.default({
    ...
    getByEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requests = yield LeaveRequestTenant_1.default.getInstance(tenantId).find({
                employee,
            });
            res.send(new ResponseResult_1.default({
    ...
    getTeamRequest(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            status = '', location = [], } = {}, } = req;
            const company = [];
            company.push(employee.company._id);
            ...
            lodash_1.map(userPermission.roles, (role) => {
                if (lodash_1.includes(['HR', 'HR-MANAGER'], role)) {
                    checkRoleHR = true;
                    return true;
                }
            });
            ...
            const items = yield LeaveRequestTenant_1.default.getInstance(tenantId).aggregate(aggregate);
            //Total
            aggregate.pop();
            ...
            const total = yield LeaveRequestTenant_1.default.getInstance(tenantId).aggregate(aggregate);
            res.send(new ResponseResult_1.default({
                data: { items, total },
    ...
    getUpcomingRequest(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tenantId } = req.body;
            const dataUpcoming = yield LeaveRequestTenant_1.default.getInstance(tenantId).find({
    ...
    getByEmployeeAndDate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield LeaveRequestTenant_1.default.getInstance(tenantId)
                .find({
                employee: employeeId,
                fromDate: { $gte: from },
                toDate: { $lt: to },
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const leaveRequest = yield LeaveRequestTenant_1.default.getInstance(tenantId).findById(_id);
            const employee = yield EmployeeTenant_1.default.getInstance(tenantId).findById(leaveRequest.employee);
            if (!leaveRequest) {
                throw new AdvancedError_1.default({
                    leaverequest: {
                        kind: 'not.found',
            ...
            const ccEmployees = yield bluebird_1.default.map(leaveRequest.cc, (ccPerson) => __awaiter(this, void 0, void 0, function* () {
                const foundCcPerson = yield EmployeeTenant_1.default.getInstance(tenantId).findById(mongoose_1.Types.ObjectId(ccPerson._id));
                return foundCcPerson;
            }));
            ...
            // const ccEmployeeGeneralInfo = await GeneralInfoTenant.getInstance(
            //   tenantId,
            // ).findOne({
            //   employee: manager,
            // })
    ...
    saveDraft(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { body } = req;
            const { tenantId, type: typeData } = body;
            // const userPermission = (await ManagePermission.findOne({
            //   userMap: currentUser.id,
            // })) as IManagePermission
            ...
            //   employee.company,
            // )
            const type = (yield TimeoffTypeTenant_1.default.getInstance(tenantId).findOne({
                _id: typeData,
            }));
            if (!type) {
                throw new AdvancedError_1.default({
    ...
    withdrawInProgress(req, res) {
      ...
      <ul>${leaveContent}</ul>
            ...
            yield LeaveRequestTenant_1.default.getInstance(tenantId).updateOne({ _id: mongoose_1.Types.ObjectId(_id) }, {
    ...
    getHrManagerByLocation(locationId, req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tenantId } = req.body;
    ...
    getByID(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = yield LeaveRequestTenant_1.default.getInstance(tenantId).aggregate(aggregates);
            res.send(new ResponseResult_1.default({
    ...
    withdrawSubmit(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { body: { tenantId, _id, title, reason }, } = req;
            const currentUser = req.user;
            const userPermission = (yield ManagePermission_1.default.findOne({
                userMap: currentUser.id,
            }));
      ...
      <p>Reason: ${reason}</p>
            ...
            // Get all HR Managers
            const hrManagers = yield this.getHrManagerByLocation(employee.location._id, req);
            const managerEmail = managerGeneralInfo.workEmail;
            // Send mail to time off requestee
            yield SendMail_1.sendLeaveRequestMail({
                email: employeeGeneralInfo.workEmail,
                fullName: requesteeName,
    ...
    withdrawApprove(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isTeamManager = leaveRequest.approvalManager.toString() === currentUser._id.toString();
            const hrManagers = yield this.getHrManagerByLocation(employee.location._id, req);
            const isHrManager = hrManagers.find(hrManager => hrManager._id.toString() === currentUser._id.toString());
            ...
            if (leaveRequest.type.type !== 'D') {
                const leaveBalance = yield LeaveRequestTenant_1.default.getInstance(tenantId).findOne({
                    employee: employeeId,
                });
                const LEAVE_TYPE = {
                ...
                yield LeaveBalanceTenant_1.default.getInstance(tenantId).updateOne({ _id: mongoose_1.Types.ObjectId(updatedLeaveBalance._id) }, updatedLeaveBalance);
            }
            // Send email notify to requestee's manager
            // Manager exist
            if (!employee.manager) {
      ...
      <p>Reason: ${leaveRequest.comment}</p>
            ...
            yield LeaveRequestTenant_1.default.getInstance(tenantId).updateOne({ _id: mongoose_1.Types.ObjectId(_id) }, { status: constant_1.TYPE_LEAVE_REQUEST.statusType.deleted });
    ...
    withdrawReject(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ccEmployees = yield bluebird_1.default.map(leaveRequest.cc, (ccPerson) => __awaiter(this, void 0, void 0, function* () {
                const foundCcPerson = yield this.EmployeeTenantModel.findById(mongoose_1.Types.ObjectId(ccPerson._id));
                return foundCcPerson;
            }));
            const leaveContent = leaveRequest.leaveDates.map((leave) => {
                const { date, timeOfDay } = leave;
      ...
      <p>Reason: ${leaveRequest.comment}</p>
            ...
            yield LeaveRequestTenant_1.default.getInstance(tenantId).updateOne({ _id: mongoose_1.Types.ObjectId(_id) }, { status: constant_1.TYPE_LEAVE_REQUEST.statusType.accepted });
    ...
    approveATicketFunc(_id, req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tenantId } = req.body;
            const leaveRequest = yield LeaveRequestTenant_1.default.getInstance(tenantId).findById(mongoose_1.Types.ObjectId(_id));
            const employee = yield EmployeeTenant_1.default.getInstance(tenantId).findById(leaveRequest.employee);
            if (!leaveRequest) {
                throw new AdvancedError_1.default({
                    leaverequest: {
...
exports.default = new LeaveRequestTenantController();
//# sourceMappingURL=LeaveRequestTenantController.js.map