...
const RoleTenant_1 = __importDefault(require("@/app/models/RoleTenant"));
const ResponseResult_1 = __importDefault(require("@/app/services/ResponseResult"));
const role_1 = require("@/app/utils/role");
const lodash_1 = require("lodash");
const User_1 = __importDefault(require("../models/User"));
class RoleTenantController extends AbstractController_1.default {
    generateMethods() {
        return [
            {
                name: 'add',
    ...
    addRole(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { body } = req;
            const { _id } = body;
            const existRole = yield RoleTenant_1.default.getInstance(tenantId).findById(_id);
            if (existRole) {
                throw new AdvancedError_1.default({
                    role: { kind: 'exists', message: 'Role is already exist' },
                });
            }
            const role = yield RoleTenant_1.default.getInstance(tenantId).create(body);
    ...
    updateRole(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { body } = req;
            const { _id } = body;
            const role = yield RoleTenant_1.default.getInstance(tenantId).findById(_id);
            if (!role) {
                throw new AdvancedError_1.default({
                    role: {
                        kind: 'not.found',
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const role = yield RoleTenant_1.default.getInstance(tenantId)
                .find({ company: undefined })
                .populate('permissions');
            let result = [];
            if (company) {
                const companyRole = yield RoleTenant_1.default.getInstance(tenantId)
                    .find({ company })
                    .populate('permissions');
    ...
    addDefault(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const tenantId = req.header('tenantId');
            const _role = yield RoleTenant_1.default.getInstance(tenantId).create(role_1.role);
            res.send(new ResponseResult_1.default({
                data: _role,
    ...
    updateByEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const roleCheck = yield RoleTenant_1.default.getInstance(tenantId).find({
                _id: { $in: roles },
            });
...
exports.default = new RoleTenantController();
//# sourceMappingURL=RoleTenantController.js.map