...
class TemplateController extends AbstractController_1.default {
    constructor(model) {
        super(model);
    ...
    getDefault(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const defaults = yield Template_1.default.find(filter);
            if (defaults) {
    ...
    getCustom(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            filter = lodash_1.pickBy(filter, lodash_1.identity);
            const customs = yield Template_1.default.find(filter);
            if (customs) {
                res.send(new ResponseResult_1.default({
    ...
    add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const template = yield Template_1.default.create(req.body);
            if (template)
                res.send(new ResponseResult_1.default({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (template) {
                ...
                res.send(new ResponseResult_1.default({
                    ...
                    data: yield Document_1.default.create({
                        key: req.body.title,
                        attachment,
...
exports.default = new TemplateController(Template_1.default);
