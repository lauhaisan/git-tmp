...
const UserActivityTenant_1 = __importDefault(require("@/app/models/UserActivityTenant"));
const ResponseResult_1 = __importDefault(require("@/app/services/ResponseResult"));
const constant_1 = require("@/app/utils/constant");
const lodash_1 = require("lodash");
class UserActivityTenantController extends AbstractController_1.default {
    generateMethods() {
        return [
            {
                name: 'list',
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield UserActivityTenant_1.default.getInstance(tenantId)
                .find(filter)
...
exports.default = new UserActivityTenantController();
//# sourceMappingURL=UserActivityTenantController.js.map