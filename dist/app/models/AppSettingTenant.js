...
class AppSettingTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_appsetting'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_appsetting', schema);
        }
        return modelObject;
    }
}
exports.default = AppSettingTenant;
//# sourceMappingURL=AppSettingTenant.js.map