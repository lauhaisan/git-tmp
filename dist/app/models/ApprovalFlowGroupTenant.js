...
class ApprovalFlowGroupTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_approvalflowgroup'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_approvalflowgroup', schema);
        }
        return modelObject;
    }
}
exports.default = ApprovalFlowGroupTenant;
//# sourceMappingURL=ApprovalFlowGroupTenant.js.map