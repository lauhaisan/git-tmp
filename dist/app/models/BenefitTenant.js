...
class BenefitTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_benefit'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_benefit', schema);
        }
        return modelObject;
    }
}
exports.default = BenefitTenant;
//# sourceMappingURL=BenefitTenant.js.map