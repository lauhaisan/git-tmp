...
class CertificationTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_certification'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_certification', schema);
        }
        return modelObject;
    }
}
exports.default = CertificationTenant;
//# sourceMappingURL=CertificationTenant.js.map