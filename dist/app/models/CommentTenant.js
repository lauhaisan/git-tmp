...
class CommentTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_comments'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_comments', schema);
        }
        return modelObject;
    }
}
exports.default = CommentTenant;
//# sourceMappingURL=CommentTenant.js.map