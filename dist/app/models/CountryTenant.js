...
class CountryTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_countries'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_countries', schema);
        }
        return modelObject;
    }
}
exports.default = CountryTenant;
//# sourceMappingURL=CountryTenant.js.map