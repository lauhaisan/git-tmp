    ...
    static getInstance(tenantId) {
        ...
        const schema = new mongoose_1.Schema({
            employee: {
                ...
                unique: [
                    true,
                    'There are dependent details for this employee already',
                ],
            },
            dependents: {
                type: [
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_dependents'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_dependents', schema);
        }
        return modelObject;
    }
}
exports.default = DependentTenant;
//# sourceMappingURL=DependentTenant.js.map