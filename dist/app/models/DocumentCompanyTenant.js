...
class DocumentCompanyTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_documentcompanies'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_documentcompanies', schema);
        }
        return modelObject;
    }
}
exports.default = DocumentCompanyTenant;
//# sourceMappingURL=DocumentCompanyTenant.js.map