...
class EmployeeTypeTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_employeetypes'];
        // return mongoose.model<IBankAcc>(prefix + '_BankAcc', bankAccSchema)
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_employeetypes', schema);
        }
        return modelObject;
    }
}
exports.default = EmployeeTypeTenant;
//# sourceMappingURL=EmployeeTypeTenant.js.map