...
class GroupTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_group'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_group', schema);
        }
        return modelObject;
    }
}
exports.default = GroupTenant;
//# sourceMappingURL=GroupTenant.js.map