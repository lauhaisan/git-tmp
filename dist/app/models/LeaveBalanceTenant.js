...
class LeaveBalanceTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_leavebalance'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_leavebalance', schema);
        }
        return modelObject;
    }
}
exports.default = LeaveBalanceTenant;
//# sourceMappingURL=LeaveBalanceTenant.js.map