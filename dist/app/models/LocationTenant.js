...
class LocationTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_locations'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_locations', schema);
        }
        return modelObject;
    }
}
exports.default = LocationTenant;
//# sourceMappingURL=LocationTenant.js.map