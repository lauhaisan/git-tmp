...
exports.offBoardingRequestSchemaDefinition = void 0;
const constant_1 = require("@/app/utils/constant");
const mongoose_1 = __importStar(require("mongoose"));
const mongoose_autopopulate_1 = __importDefault(require("mongoose-autopopulate"));
const mongoose_beautiful_unique_validation_1 = __importDefault(require("mongoose-beautiful-unique-validation"));
// import OffBoardingRequestComment from './OffBoardingRequestComment'
...
exports.offBoardingRequestSchemaDefinition = {
    ticketID: {
        type: String,
        required: true,
        unique: true,
    ...
    approvalFlow: {
        ...
        type: mongoose_1.Schema.Types.ObjectId,
        ref: 'ApprovalFlow',
        autopopulate: { select: constant_1.MODEL_POPULATE.approvalFlow },
    },
...
const offBoardingRequestSchema = new mongoose_1.Schema(exports.offBoardingRequestSchemaDefinition, {
    timestamps: true,
    versionKey: false,
});
offBoardingRequestSchema.plugin(mongoose_beautiful_unique_validation_1.default);
offBoardingRequestSchema.plugin(mongoose_autopopulate_1.default);
const OffBoardingRequest = mongoose_1.default.model('offBoardingRequest', offBoardingRequestSchema);
exports.default = OffBoardingRequest;
//# sourceMappingURL=OffBoardingRequest.js.map