...
class PayslipTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_payslip'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_payslip', schema);
        }
        return modelObject;
    }
}
exports.default = PayslipTenant;
//# sourceMappingURL=PayslipTenant.js.map