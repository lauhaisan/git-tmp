...
class PromoteHistoryTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_promotehistory'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_promotehistory', schema);
        }
        return modelObject;
    }
}
exports.default = PromoteHistoryTenant;
//# sourceMappingURL=PromoteHistoryTenant.js.map