...
const settingCountrySchema = new mongoose_1.Schema({
    country: {
        type: String,
        unique: true,
        required: true,
...
settingCountrySchema.plugin(mongoose_beautiful_unique_validation_1.default);
const SettingCountry = mongoose_1.default.model('SettingCountry', settingCountrySchema);
exports.default = SettingCountry;
//# sourceMappingURL=SettingCountry.js.map