...
class TimeoffTypeTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_timeofftypes'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_timeofftypes', schema);
        }
        return modelObject;
    }
}
exports.default = TimeoffTypeTenant;
//# sourceMappingURL=TimeoffTypeTenant.js.map