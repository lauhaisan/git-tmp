...
class VisaTenant {
    ...
    static getInstance(tenantId) {
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + '_visas'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + '_visas', schema);
        }
        return modelObject;
    }
}
exports.default = VisaTenant;
//# sourceMappingURL=VisaTenant.js.map