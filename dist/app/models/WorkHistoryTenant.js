...
class WorkHistoryTenant {
    ...
    static getInstance(tenantId) {
        ...
        const schema = new mongoose_1.Schema({
            ...
            candidate: {
                type: mongoose_1.Schema.Types.ObjectId,
                //ref: CandidateTenant.getInstance(this.tenantId),
                required: true,
            },
            employer: {
                type: String,
        ...
        let modelObject = mongoose_1.default.models[this.tenantId + 'workhistories'];
        if (!modelObject) {
            modelObject = mongoose_1.default.model(this.tenantId + 'workhistories', schema);
        }
        return modelObject;
    }
}
exports.default = WorkHistoryTenant;
//# sourceMappingURL=WorkHistoryTenant.js.map